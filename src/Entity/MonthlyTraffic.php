...
#[ORM\UniqueConstraint(name: 'ims_monthly_traffic_node_month_idx_unique', columns: ['node_id', 'month'])]
class MonthlyTraffic implements \Stringable
{
    ...
    #[Assert\Regex(pattern: '/^\d{4}-\d{2}$/', message: 'Month must be in format YYYY-MM')]
