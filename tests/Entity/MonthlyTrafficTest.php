 ...
 * @internal
 */
#[CoversClass(MonthlyTraffic::class)]
final class MonthlyTrafficTest extends AbstractEntityTestCase
{
    ...
    public static function propertiesProvider(): iterable
    {
        ...
        yield 'month' => ['month', '2023-01'];
        yield 'tx' => ['tx', '10240000'];
        yield 'rx' => ['rx', '20480000'];
    }
